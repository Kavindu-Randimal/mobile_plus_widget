//
//  RecoveryEmailOptionRadioBtnViewNotSelected.swift
//  ZorroSign
//
...
class RecoveryEmailOptionRadioBtnViewNotSelected: UIView {
...
extension RecoveryEmailOptionRadioBtnViewNotSelected {
...
extension RecoveryEmailOptionRadioBtnViewNotSelected {
    @objc private func selectOptoin(_ sender: UIButton) {
        print("Chathura option index clicked")
